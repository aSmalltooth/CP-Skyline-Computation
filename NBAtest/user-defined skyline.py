...
filtered_data = [point for point in data if float(point['pts']) > 18 and float(point['reb']) > 5 and float(point['ast']) > 3 and float(point['net_rating']) > 4 and float(point['usg_pct']) > 0.3]
